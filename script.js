...
window.onload = function () {
    ...
    // creo un event listener x far funzionare la calcolatrice anche con i tasti 
    document.addEventListener('keydown', function(event) {
        ...
        if (!operation) {
           ...
           if ((event.key === "Enter")||(event.key === "=")) {
            ...
            } else if (event.key === "c") { // reset
                operator1 = 0
                operation = undefined
                operator2 = 0
                display.innerHTML = 0

                // se l'event key è uguale ai segni delle diverse operazioni allora:
